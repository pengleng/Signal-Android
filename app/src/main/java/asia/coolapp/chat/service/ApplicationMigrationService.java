...
import asia.coolapp.chat.database.SmsMigrator;
import asia.coolapp.chat.database.SmsMigrator.ProgressDescription;
    ...
    implements SmsMigrator.SmsMigrationProgressListener
{
  ...
  public  static final String MIGRATE_DATABASE  = "asia.coolapp.chat.ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = "asia.coolapp.chat.ApplicationMigrationService.COMPLETED";

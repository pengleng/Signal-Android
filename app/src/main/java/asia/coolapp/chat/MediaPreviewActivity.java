...
import asia.coolapp.chat.animation.DepthPageTransformer;
import asia.coolapp.chat.attachments.DatabaseAttachment;
import asia.coolapp.chat.components.viewpager.ExtendedOnPageChangedListener;
import asia.coolapp.chat.database.MediaDatabase;
import asia.coolapp.chat.database.MediaDatabase.MediaRecord;
import asia.coolapp.chat.database.loaders.PagingMediaLoader;
import asia.coolapp.chat.mediaoverview.MediaOverviewActivity;
import asia.coolapp.chat.mediapreview.MediaPreviewFragment;
import asia.coolapp.chat.mediapreview.MediaPreviewViewModel;
import asia.coolapp.chat.mediapreview.MediaRailAdapter;
...
import asia.coolapp.chat.sharing.ShareActivity;
import asia.coolapp.chat.util.AttachmentUtil;
...
import asia.coolapp.chat.util.SaveAttachmentTask.Attachment;

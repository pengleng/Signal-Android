...
import asia.coolapp.chat.service.SmsDeliveryListener;
...
public class SmsSendJob extends SendJob {
  ...
  public static class Factory implements Job.Factory<SmsSendJob> {
    @Override
    public @NonNull SmsSendJob create(@NonNull Parameters parameters, @NonNull asia.coolapp.chat.jobmanager.Data data) {

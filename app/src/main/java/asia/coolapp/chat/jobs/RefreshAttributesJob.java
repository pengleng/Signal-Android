...
import asia.coolapp.chat.registration.secondary.DeviceNameCipher;
...
public class RefreshAttributesJob extends BaseJob {
  ...
  public static class Factory implements Job.Factory<RefreshAttributesJob> {
    @Override
    public @NonNull RefreshAttributesJob create(@NonNull Parameters parameters, @NonNull asia.coolapp.chat.jobmanager.Data data) {

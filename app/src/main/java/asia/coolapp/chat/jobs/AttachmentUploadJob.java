...
import asia.coolapp.chat.blurhash.BlurHashEncoder;
...
public final class AttachmentUploadJob extends BaseJob {
  ...
  public static final class Factory implements Job.Factory<AttachmentUploadJob> {
    @Override
    public @NonNull AttachmentUploadJob create(@NonNull Parameters parameters, @NonNull asia.coolapp.chat.jobmanager.Data data) {

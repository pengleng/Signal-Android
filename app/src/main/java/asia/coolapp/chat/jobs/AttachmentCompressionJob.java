...
import asia.coolapp.chat.events.PartProgressEvent;
...
import asia.coolapp.chat.util.BitmapDecodingException;
import asia.coolapp.chat.util.FeatureFlags;
import asia.coolapp.chat.util.ImageCompressionUtil;
import asia.coolapp.chat.util.MediaUtil;
import asia.coolapp.chat.util.MemoryFileDescriptor;
import asia.coolapp.chat.util.MemoryFileDescriptor.MemoryFileException;
import asia.coolapp.chat.video.InMemoryTranscoder;
import asia.coolapp.chat.video.StreamingTranscoder;
import asia.coolapp.chat.video.TranscoderCancelationSignal;
import asia.coolapp.chat.video.TranscoderOptions;
import asia.coolapp.chat.video.VideoSourceException;

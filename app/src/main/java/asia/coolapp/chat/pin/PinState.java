...
public final class PinState {
  ...
  /**
   * Should only be called by {@link asia.coolapp.chat.migrations.RegistrationPinV2MigrationJob}.
   */
  @WorkerThread
  ...
  /**
   * Should only be called by {@link asia.coolapp.chat.jobs.KbsEnclaveMigrationWorkerJob}.
   */
  @WorkerThread

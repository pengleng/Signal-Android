...
public class VoiceNotePlaybackService extends MediaBrowserServiceCompat {
  ...
  public static final String ACTION_NEXT_PLAYBACK_SPEED = "asia.coolapp.chat.components.voice.VoiceNotePlaybackService.action.next_playback_speed";
  public static final String ACTION_SET_AUDIO_STREAM    = "asia.coolapp.chat.components.voice.VoiceNotePlaybackService.action.set_audio_stream";

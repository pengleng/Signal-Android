...
import asia.coolapp.chat.components.RecyclerViewFastScroller;
import asia.coolapp.chat.components.recyclerview.ToolbarShadowAnimationHelper;
import asia.coolapp.chat.contacts.AbstractContactsCursorLoader;
import asia.coolapp.chat.contacts.ContactChip;
import asia.coolapp.chat.contacts.ContactSelectionListAdapter;
import asia.coolapp.chat.contacts.ContactSelectionListItem;
...
import asia.coolapp.chat.contacts.LetterHeaderDecoration;
...
import asia.coolapp.chat.sharing.ShareContact;
import asia.coolapp.chat.util.TextSecurePreferences;
import asia.coolapp.chat.util.UsernameUtil;
import asia.coolapp.chat.util.ViewUtil;
import asia.coolapp.chat.util.adapter.FixedViewsAdapter;
import asia.coolapp.chat.util.adapter.RecyclerViewConcatenateAdapterStickyHeader;

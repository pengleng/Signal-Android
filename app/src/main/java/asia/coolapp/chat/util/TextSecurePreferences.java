...
import asia.coolapp.chat.backup.BackupProtos;
...
import asia.coolapp.chat.lock.RegistrationLockReminders;
...
public class TextSecurePreferences {
  ...
  /**
   * @deprecated Use {@link SettingsValues#getMessageFontSize()} via {@link asia.coolapp.chat.keyvalue.SignalStore} instead.
   */
  ...
  /**
   * @deprecated Use {@link SettingsValues#getTheme()} via {@link asia.coolapp.chat.keyvalue.SignalStore} instead.
   */
  ...
  /**
   * @deprecated Use {@link SettingsValues#getLanguage()} via {@link asia.coolapp.chat.keyvalue.SignalStore} instead.
   */
  ...
  /**
   * @deprecated Use {@link SettingsValues#setLanguage(String)} via {@link asia.coolapp.chat.keyvalue.SignalStore} instead.
   */

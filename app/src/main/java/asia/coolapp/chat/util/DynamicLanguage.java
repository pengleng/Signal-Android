...
import asia.coolapp.chat.util.dynamiclanguage.LanguageString;

import java.util.Locale;

/**
 * @deprecated Use a base activity that uses the {@link asia.coolapp.chat.util.dynamiclanguage.DynamicLanguageContextWrapper}
 */
@Deprecated

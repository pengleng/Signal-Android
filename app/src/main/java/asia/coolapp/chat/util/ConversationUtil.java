...
import asia.coolapp.chat.jobs.ConversationShortcutUpdateJob;
...
public final class ConversationUtil {
  ...
  private static final String CATEGORY_SHARE_TARGET = "asia.coolapp.chat.sharing.CATEGORY_SHARE_TARGET";
                                                               ...
                                                               int rank)
  {
    ...
    return new ShortcutInfoCompat.Builder(context, shortcutId)
                                 ...
                                 .setActivity(new ComponentName(context, "asia.coolapp.chat.RoutingActivity"))
                                 .setRank(rank)

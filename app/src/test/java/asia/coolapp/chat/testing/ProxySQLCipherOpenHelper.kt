package asia.coolapp.chat.testing
...
class ProxySQLCipherOpenHelper(
  ...
  override val signalReadableDatabase: asia.coolapp.chat.database.SQLiteDatabase
    get() = ProxySignalSQLiteDatabase(readableDatabase)

  override val signalWritableDatabase: asia.coolapp.chat.database.SQLiteDatabase
